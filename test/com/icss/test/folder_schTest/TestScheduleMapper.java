...
public class TestScheduleMapper {
	...
	public void testInsert() {
		...
		employee.setEmpId(2);
		Schedule sch = new Schedule("北京开会", "参加全国人代会", Date.valueOf("2010-10-21"), Date.valueOf("2011-01-21"),
				Date.valueOf("2011-03-01"), emp, employee);
		mapper.insert(sch);
	}
	...
	public void testUpdate() {
		...
		emp2.setEmpId(3);
		Schedule schedule = new Schedule(4, "我不知道", "你自己去猜", Date.valueOf("2010-01-10"), Date.valueOf("2010-07-14"),
				Date.valueOf("2011-01-12"), emp1, emp2);
		mapper.update(schedule);
	}

	@Test
	public void testQueryById() {
		System.out.println(mapper.queryById(13));
	}
	...
	public void testQueryByCondition() {
		List<Schedule> list = mapper.queryByCondition(0, 10, 3, 2, "");
		for (Schedule sch : list) {
			System.out.println(sch);
		}
	}
	...
	public void testGetCountByCondition() {
		...
		System.out.println(mapper.getCountByCondition(3, 2, ""));
	}
}
